# Event Onboarding Protocol

> **Status:** In Bearbeitung — wird schrittweise befüllt
...
**Kommissionssystem / Tool:** _[wird ergänzt]_
**Trainer:** _[wird ergänzt]_
...
| Rolle | Name | Telefon | E-Mail | Zuständig für |
|-------|------|---------|--------|---------------|
| Projektleitung | _[wird ergänzt]_ | _[wird ergänzt]_ | _[wird ergänzt]_ | Gesamtkoordination |
| Operations-Lead | _[wird ergänzt]_ | _[wird ergänzt]_ | _[wird ergänzt]_ | Outlets, Logistik |
| Lager- / Kommissions-Lead | _[wird ergänzt]_ | _[wird ergänzt]_ | _[wird ergänzt]_ | Lager, Kommissionierung |
| Technik-Lead | _[wird ergänzt]_ | _[wird ergänzt]_ | _[wird ergänzt]_ | Systeme, IT |
| HR / Onboarding-Lead | _[wird ergänzt]_ | _[wird ergänzt]_ | _[wird ergänzt]_ | Personal, Einarbeitung |
| Security-Lead | _[wird ergänzt]_ | _[wird ergänzt]_ | _[wird ergänzt]_ | Sicherheit |
...
| Lokale Polizeidienststelle | _[wird ergänzt]_ |
| Nächstes Krankenhaus | _[wird ergänzt]_ |
...
| Kanal | Details |
|-------|---------|
| Funk-Kanal Leads | _[wird ergänzt]_ |
| Funk-Kanal Outlets | _[wird ergänzt]_ |
| Funk-Kanal Lager/Kommission | _[wird ergänzt]_ |
| WhatsApp/Signal Gesamtteam | _[wird ergänzt]_ |
| WhatsApp/Signal Leads | _[wird ergänzt]_ |
...
│   ├── Outlet-Lead 2
│   └── Outlet-Lead N
├── Lager- & Kommissions-Lead
│   └── Kommissionierer-Team
├── Technik-Lead
│   └── IT-Support
├── HR / Onboarding-Lead
└── Security-Lead
...
| Stufe | Beschreibung | Maßnahme | Ansprechpartner |
|-------|-------------|----------|-----------------|
...
| Medium | Wann | Wer |
|--------|------|-----|
| Funk | Laufend operativ | Alle Leads & Outlets |
| Morgen-Briefing | Täglich zu Schichtbeginn | Alle Leads |
| WhatsApp Leads-Gruppe | Infos, Entscheidungen, Eskalation | Leads |
| WhatsApp Gesamtteam | Ankündigungen | Projektleitung → alle |
...
*Protokoll erstellt: 2026-04-09 | Branch: `claude/event-onboarding-protocol-LZIGG`*
